...
-- Enforce case-insensitive uniqueness while preserving original casing.
...
CREATE INDEX IF NOT EXISTS idx_panorama_hotspots_project_id ON panorama_hotspots(project_id);
...
CREATE INDEX IF NOT EXISTS idx_layout_hotspots_project_id ON layout_hotspots(project_id);
...
CREATE INDEX IF NOT EXISTS idx_blur_masks_project_id ON blur_masks(project_id);
